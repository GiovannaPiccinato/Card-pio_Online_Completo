...
var CELULAR_EMPRESA = '5511955207242';
...
cardapio.metodos = {
	...
	obterItensCardapio: (categoria = 'burgers', vermais = false) => {
			...
			if (!vermais) {
					$("#itensCardapio").html(''); // iremos limpar o cardapio.
	...
	mensagem: (texto, cor = 'red', tempo = 3500) => {
			...
			let id = Math.floor(Date.now() * Math.random()).toString(); // id nao irá se repetir nunca.
